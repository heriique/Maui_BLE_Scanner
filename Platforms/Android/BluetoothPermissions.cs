// from github/salarcode/Bluetoothpermissions
...
namespace MauiApp1.Platforms.Android
{
    public partial class BluetoothPermissions : Permissions.BasePlatformPermission
    {
        ...
        {
            System.Diagnostics.Debug.WriteLine("|-|-|-|-|-|-|-|-|-|-|-|Android Bt permissions|-|-|-|-|-|-|-|--|");
        }
        ...
        public override (string androidPermission, bool isRuntime)[] RequiredPermissions
        {
            get
            {
                ...
                if (sdk >= 31)
                {
                    ...
                    result.Add((global::Android.Manifest.Permission_group.NearbyDevices, true));
                }
                else
                {
